...
def main():
    ...
    #plt.show()#mouse.py:102: UserWarning: Matplotlib is currently using agg, which is a non-GUI backend, so cannot show the figure.
    plt.savefig('mouse_out.png')
    # clean temp data
    os.system("del %s" % (DataFileName))
